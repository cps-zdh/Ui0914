...
public class JGFASHPage extends BasePage{
	 ...
	 * 审核按钮
	 */
	private String auditButton="//*[@id=\"home\"]/div[2]/div/div/div[2]/div[2]/div[1]/div[4]/div[2]/table/tbody/tr[1]/td[13]/div/button/span";
	 ...
	 * @throws InterruptedException 
	 */
	public void auditPriceProgram() throws InterruptedException {
		LoggerUtil.info("开始审核价格方案...");
		sleep(3000);
